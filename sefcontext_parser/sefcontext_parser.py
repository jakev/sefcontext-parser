...
def main():
    ...
    parser.add_argument('binary_sefcontexts', type=str,
                        help='Binary sefcontext file to parse.')
    parser.add_argument('-o', '--outfile',
                        help='Output file name (default: file_contexts).',
                        default="file_contexts")
    parser.add_argument('-D', '--debug', action='store_const',
                        dest='debugging', const=True, default=False,
    ...
    if not os.path.isfile(args.binary_sefcontexts):
        print("Error: input file '%s' doesn't exist!"
              % args.binary_sefcontexts)
        return 1

    sef_parser = SefContextParser(args.binary_sefcontexts,
